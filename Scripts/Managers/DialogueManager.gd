...
@export var dialogue_ui_scene: PackedScene = preload("res://Scenes/Overlays/DialogueLayer.tscn")
...
func current_id() -> String: return _current_id
func current_line() -> Dictionary: return _current_line
